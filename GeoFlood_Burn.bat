...
python .\GeoFlood\DEM_Burn.py
mpiexec -n 4 .\TauDEM\pitremove -z ..\Outputs\GIS\\%projectName%\\%DEM_name%_burn.tif -fel ..\Outputs\GIS\\%projectName%\\%DEM_name%_burnfel.tif
mpiexec -n 4 .\TauDEM\d8flowdir -fel ..\Outputs\GIS\\%projectName%\\%DEM_name%_burnfel.tif -p ..\Outputs\GIS\\%projectName%\\%DEM_name%_burnp.tif -sd8 ..\Outputs\GIS\\%projectName%\\%DEM_name%_burnsd8.tif
python .\GeoFlood\Streamline_Flowdirection_Mask.py
mpiexec -n 4 .\TauDEM\flowdircond -z ..\Inputs\GIS\\%projectName%\\%DEM_name%.tif -p ..\Outputs\GIS\\%projectName%\\%DEM_name%_streamp.tif -zfdc ..\Outputs\GIS\\%projectName%\\%DEM_name%_fdc.tif
python .\GeoFlood\River_Attribute_Estimation.py
python .\GeoFlood\Network_Mapping.py
mpiexec -n 4 .\TauDEM\pitremove -z ..\Outputs\GIS\\%projectName%\\%DEM_name%_fdc.tif -fel ..\Outputs\GIS\\%projectName%\\%DEM_name%_fel.tif
